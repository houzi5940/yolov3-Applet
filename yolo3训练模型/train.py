...
tf.compat.v1.keras.backend.set_session(tf.compat.v1.Session(
    config=config))  # 注意 ，这里为tensorflow2.0版本，与第1.0有差距。
...
if __name__ == "__main__":
    ...
    # model.load_weights('logs/yolo.h5')
    ...
    if True:
        ...
        print('Train 50 epochs model save in :',
              log_dir, 'trained_weights_stage_1.h5')
    # 出错接着训练，注释掉之前的
    model.load_weights('logs/ep010-loss26.584-val_loss24.266.h5')
